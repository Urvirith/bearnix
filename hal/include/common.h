...
//void clr_ptr_vol_bit_u32(volatile u32 *ptr, u32 value);                                         /* Clear a pointer bit in a u32 ptr Example value (1 << 5) */
//u32 get_ptr_vol_u32(volatile u32 *ptr, u32 offset, u32 mask);                                   /* Get a pointer bit in a u32 ptr Example value (10000 >> 5) -> 1 */
//void set_ptr_vol_u32(volatile u32 *ptr, u32 offset, u32 mask, u32 value);                       /* Write to a pointer with offset and mask size, ensure mask >= value */
